...
static PyMethodDef mod_g6exle1y2dci_g6exle1y2dci_methods[] = {
    {
        "matrix_prod",
...
static PyModuleDef_Slot mod_g6exle1y2dci_g6exle1y2dci_slots[] = {
...
static struct PyModuleDef mod_g6exle1y2dci_g6exle1y2dci_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_g6exle1y2dci_g6exle1y2dci",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_g6exle1y2dci_g6exle1y2dci_methods,
    mod_g6exle1y2dci_g6exle1y2dci_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_g6exle1y2dci_g6exle1y2dci(void)
{
    import_array();
    return PyModuleDef_Init(&mod_g6exle1y2dci_g6exle1y2dci_module);
}
