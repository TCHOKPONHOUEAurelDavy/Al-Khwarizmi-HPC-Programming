module bind_c_naviestock_xt3ixussfk2s_xt3ixussfk2s

  use naviestock_xt3ixussfk2s_xt3ixussfk2s, only: build_up_b_numba
  use naviestock_xt3ixussfk2s_xt3ixussfk2s, only: pressure_poisson_numba
  use naviestock_xt3ixussfk2s_xt3ixussfk2s, only: cavity_flow_numba
...
end module bind_c_naviestock_xt3ixussfk2s_xt3ixussfk2s
