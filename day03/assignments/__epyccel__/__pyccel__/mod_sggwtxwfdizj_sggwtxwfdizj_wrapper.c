...
int bind_c_jacobi(int64_t n0_a, int64_t n1_a, double *a, int64_t n0_b, double *b, int64_t n0_x, double *x, int64_t n, double eps, int64_t *stand, int64_t *iteration);
...
static PyMethodDef mod_sggwtxwfdizj_sggwtxwfdizj_methods[] = {
    {
        "jacobi",
...
static PyModuleDef_Slot mod_sggwtxwfdizj_sggwtxwfdizj_slots[] = {
...
static struct PyModuleDef mod_sggwtxwfdizj_sggwtxwfdizj_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_sggwtxwfdizj_sggwtxwfdizj",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_sggwtxwfdizj_sggwtxwfdizj_methods,
    mod_sggwtxwfdizj_sggwtxwfdizj_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_sggwtxwfdizj_sggwtxwfdizj(void)
{
    import_array();
    return PyModuleDef_Init(&mod_sggwtxwfdizj_sggwtxwfdizj_module);
}
