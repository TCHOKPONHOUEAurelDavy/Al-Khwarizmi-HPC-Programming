module bind_c_reduction_tab_ceswnjazh3do_ceswnjazh3do

  use reduction_tab_ceswnjazh3do_ceswnjazh3do, only: reduction
  use reduction_tab_ceswnjazh3do_ceswnjazh3do, only: initialize_table
...
end module bind_c_reduction_tab_ceswnjazh3do_ceswnjazh3do
