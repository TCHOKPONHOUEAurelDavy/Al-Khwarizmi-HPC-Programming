module bind_c_naviestock_786qjenk4d83_786qjenk4d83

  use naviestock_786qjenk4d83_786qjenk4d83, only: cavity_flow_numba
  use naviestock_786qjenk4d83_786qjenk4d83, only: pressure_poisson_numba
  use naviestock_786qjenk4d83_786qjenk4d83, only: build_up_b_numba
  ...
  function bind_c_pressure_poisson_numba(n0_p, n1_p, p, dx, dy, n0_b, &
        n1_b, b, nt) bind(c) result(Out_0002)
    ...
    Out_0002 = pressure_poisson_numba(p, dx, dy, b, nt)

  end function bind_c_pressure_poisson_numba
  !........................................

  !........................................
  function bind_c_cavity_flow_numba(nt, n0_u, n1_u, u, n0_v, n1_v, v, dt &
        , nx, ny, dx, dy, n0_p, n1_p, p, rho, nu) bind(c) result( &
        Out_0003)
    ...
    Out_0003 = cavity_flow_numba(nt, u, v, dt, nx, ny, dx, dy, p, rho, &
          nu)

  end function bind_c_cavity_flow_numba
  !........................................

end module bind_c_naviestock_786qjenk4d83_786qjenk4d83
