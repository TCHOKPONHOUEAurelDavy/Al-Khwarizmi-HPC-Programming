module bind_c_reduction_tab_hpzo9mcxm6ai_hpzo9mcxm6ai

  use reduction_tab_hpzo9mcxm6ai_hpzo9mcxm6ai, only: initialize_table
  use reduction_tab_hpzo9mcxm6ai_hpzo9mcxm6ai, only: reduction
...
end module bind_c_reduction_tab_hpzo9mcxm6ai_hpzo9mcxm6ai
