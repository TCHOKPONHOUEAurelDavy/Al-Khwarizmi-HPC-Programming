module bind_c_naviestock_cmomgpzrqww9_cmomgpzrqww9

  use naviestock_cmomgpzrqww9_cmomgpzrqww9, only: pressure_poisson_numba
  use naviestock_cmomgpzrqww9_cmomgpzrqww9, only: build_up_b_numba
  use naviestock_cmomgpzrqww9_cmomgpzrqww9, only: cavity_flow_numba
...
end module bind_c_naviestock_cmomgpzrqww9_cmomgpzrqww9
