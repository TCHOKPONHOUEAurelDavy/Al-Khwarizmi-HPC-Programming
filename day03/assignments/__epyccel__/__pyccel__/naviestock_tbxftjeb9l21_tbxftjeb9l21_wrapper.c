...
int64_t bind_c_pressure_poisson_numba(int64_t n0_p, int64_t n1_p, double *p, double dx, double dy, int64_t n0_b, int64_t n1_b, double *b, int64_t nit);
...
PyObject *pressure_poisson_numba_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    Out_0002 = bind_c_pressure_poisson_numba(nd_ndim(&p, 0), nd_ndim(&p, 1), nd_data(&p), dx, dy, nd_ndim(&b, 0), nd_ndim(&b, 1), nd_data(&b), nit);
...
static PyMethodDef naviestock_tbxftjeb9l21_tbxftjeb9l21_methods[] = {
    {
        "build_up_b_numba",
...
static PyModuleDef_Slot naviestock_tbxftjeb9l21_tbxftjeb9l21_slots[] = {
...
static struct PyModuleDef naviestock_tbxftjeb9l21_tbxftjeb9l21_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "naviestock_tbxftjeb9l21_tbxftjeb9l21",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    naviestock_tbxftjeb9l21_tbxftjeb9l21_methods,
    naviestock_tbxftjeb9l21_tbxftjeb9l21_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_naviestock_tbxftjeb9l21_tbxftjeb9l21(void)
{
    import_array();
    return PyModuleDef_Init(&naviestock_tbxftjeb9l21_tbxftjeb9l21_module);
}
