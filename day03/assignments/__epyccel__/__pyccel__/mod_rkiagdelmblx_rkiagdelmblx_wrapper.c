...
static PyMethodDef mod_rkiagdelmblx_rkiagdelmblx_methods[] = {
    {
        "matrix_prod",
...
static PyModuleDef_Slot mod_rkiagdelmblx_rkiagdelmblx_slots[] = {
...
static struct PyModuleDef mod_rkiagdelmblx_rkiagdelmblx_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_rkiagdelmblx_rkiagdelmblx",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_rkiagdelmblx_rkiagdelmblx_methods,
    mod_rkiagdelmblx_rkiagdelmblx_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_rkiagdelmblx_rkiagdelmblx(void)
{
    import_array();
    return PyModuleDef_Init(&mod_rkiagdelmblx_rkiagdelmblx_module);
}
