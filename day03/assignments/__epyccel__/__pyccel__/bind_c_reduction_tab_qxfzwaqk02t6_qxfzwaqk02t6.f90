module bind_c_reduction_tab_qxfzwaqk02t6_qxfzwaqk02t6

  use reduction_tab_qxfzwaqk02t6_qxfzwaqk02t6, only: initialize_table
  use reduction_tab_qxfzwaqk02t6_qxfzwaqk02t6, only: reduction
...
end module bind_c_reduction_tab_qxfzwaqk02t6_qxfzwaqk02t6
