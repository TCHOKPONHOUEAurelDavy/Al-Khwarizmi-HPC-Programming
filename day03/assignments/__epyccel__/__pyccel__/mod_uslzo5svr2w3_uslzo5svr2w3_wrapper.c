...
static PyMethodDef mod_uslzo5svr2w3_uslzo5svr2w3_methods[] = {
    {
        "jacobi",
...
static PyModuleDef_Slot mod_uslzo5svr2w3_uslzo5svr2w3_slots[] = {
...
static struct PyModuleDef mod_uslzo5svr2w3_uslzo5svr2w3_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_uslzo5svr2w3_uslzo5svr2w3",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_uslzo5svr2w3_uslzo5svr2w3_methods,
    mod_uslzo5svr2w3_uslzo5svr2w3_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_uslzo5svr2w3_uslzo5svr2w3(void)
{
    import_array();
    return PyModuleDef_Init(&mod_uslzo5svr2w3_uslzo5svr2w3_module);
}
