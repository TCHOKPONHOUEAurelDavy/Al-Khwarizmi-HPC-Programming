module bind_c_naviestock_vwj751lyprvg_vwj751lyprvg

  use naviestock_vwj751lyprvg_vwj751lyprvg, only: build_up_b_numba
  use naviestock_vwj751lyprvg_vwj751lyprvg, only: cavity_flow_numba
  use naviestock_vwj751lyprvg_vwj751lyprvg, only: pressure_poisson_numba
...
end module bind_c_naviestock_vwj751lyprvg_vwj751lyprvg
