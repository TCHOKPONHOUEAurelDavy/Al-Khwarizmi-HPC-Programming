...
static PyMethodDef naviestock_tjs8y3mjhame_tjs8y3mjhame_methods[] = {
    {
        "build_up_b_numba",
...
static PyModuleDef_Slot naviestock_tjs8y3mjhame_tjs8y3mjhame_slots[] = {
...
static struct PyModuleDef naviestock_tjs8y3mjhame_tjs8y3mjhame_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "naviestock_tjs8y3mjhame_tjs8y3mjhame",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    naviestock_tjs8y3mjhame_tjs8y3mjhame_methods,
    naviestock_tjs8y3mjhame_tjs8y3mjhame_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_naviestock_tjs8y3mjhame_tjs8y3mjhame(void)
{
    import_array();
    return PyModuleDef_Init(&naviestock_tjs8y3mjhame_tjs8y3mjhame_module);
}
