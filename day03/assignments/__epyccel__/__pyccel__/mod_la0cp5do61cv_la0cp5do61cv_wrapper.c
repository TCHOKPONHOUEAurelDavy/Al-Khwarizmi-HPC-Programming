...
static PyMethodDef mod_la0cp5do61cv_la0cp5do61cv_methods[] = {
    {
        "strassen_multiply",
...
static PyModuleDef_Slot mod_la0cp5do61cv_la0cp5do61cv_slots[] = {
...
static struct PyModuleDef mod_la0cp5do61cv_la0cp5do61cv_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_la0cp5do61cv_la0cp5do61cv",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_la0cp5do61cv_la0cp5do61cv_methods,
    mod_la0cp5do61cv_la0cp5do61cv_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_la0cp5do61cv_la0cp5do61cv(void)
{
    import_array();
    return PyModuleDef_Init(&mod_la0cp5do61cv_la0cp5do61cv_module);
}
