...
int64_t bind_c_cavity_flow_numba(int64_t nt, int64_t n0_u, int64_t n1_u, double *u, int64_t n0_v, int64_t n1_v, double *v, double dt, int64_t nx, int64_t ny, double dx, double dy, int64_t n0_p, int64_t n1_p, double *p, double rho, double nu, int64_t nit);
...
PyObject *cavity_flow_numba_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    Out_0003 = bind_c_cavity_flow_numba(nt, nd_ndim(&u, 0), nd_ndim(&u, 1), nd_data(&u), nd_ndim(&v, 0), nd_ndim(&v, 1), nd_data(&v), dt, nx, ny, dx, dy, nd_ndim(&p, 0), nd_ndim(&p, 1), nd_data(&p), rho, nu, nit);
...
static PyMethodDef naviestock_tk9ftu2rjlas_tk9ftu2rjlas_methods[] = {
    {
        "build_up_b_numba",
...
static PyModuleDef_Slot naviestock_tk9ftu2rjlas_tk9ftu2rjlas_slots[] = {
...
static struct PyModuleDef naviestock_tk9ftu2rjlas_tk9ftu2rjlas_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "naviestock_tk9ftu2rjlas_tk9ftu2rjlas",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    naviestock_tk9ftu2rjlas_tk9ftu2rjlas_methods,
    naviestock_tk9ftu2rjlas_tk9ftu2rjlas_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_naviestock_tk9ftu2rjlas_tk9ftu2rjlas(void)
{
    import_array();
    return PyModuleDef_Init(&naviestock_tk9ftu2rjlas_tk9ftu2rjlas_module);
}
