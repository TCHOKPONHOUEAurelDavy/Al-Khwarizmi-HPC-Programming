module bind_c_naviestock_iwwtjbqln12a_iwwtjbqln12a

  use naviestock_iwwtjbqln12a_iwwtjbqln12a, only: build_up_b_numba
  use naviestock_iwwtjbqln12a_iwwtjbqln12a, only: pressure_poisson_numba
  use naviestock_iwwtjbqln12a_iwwtjbqln12a, only: cavity_flow_numba
...
end module bind_c_naviestock_iwwtjbqln12a_iwwtjbqln12a
