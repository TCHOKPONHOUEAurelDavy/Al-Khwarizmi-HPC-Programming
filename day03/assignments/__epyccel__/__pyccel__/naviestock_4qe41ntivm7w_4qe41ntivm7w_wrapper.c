...
int64_t bind_c_pressure_poisson_numba(int64_t n0_p, int64_t n1_p, double *p, double dx, double dy, int64_t n0_b, int64_t n1_b, double *b, int64_t nit, int64_t nt);
int64_t bind_c_cavity_flow_numba(int64_t n0_u, int64_t n1_u, double *u, int64_t n0_v, int64_t n1_v, double *v, double dt, int64_t nx, int64_t ny, double dx, double dy, int64_t n0_p, int64_t n1_p, double *p, double rho, double nu, int64_t nit, int64_t nt);
...
static PyMethodDef naviestock_4qe41ntivm7w_4qe41ntivm7w_methods[] = {
    {
        "build_up_b_numba",
...
static PyModuleDef_Slot naviestock_4qe41ntivm7w_4qe41ntivm7w_slots[] = {
...
static struct PyModuleDef naviestock_4qe41ntivm7w_4qe41ntivm7w_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "naviestock_4qe41ntivm7w_4qe41ntivm7w",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    naviestock_4qe41ntivm7w_4qe41ntivm7w_methods,
    naviestock_4qe41ntivm7w_4qe41ntivm7w_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_naviestock_4qe41ntivm7w_4qe41ntivm7w(void)
{
    import_array();
    return PyModuleDef_Init(&naviestock_4qe41ntivm7w_4qe41ntivm7w_module);
}
