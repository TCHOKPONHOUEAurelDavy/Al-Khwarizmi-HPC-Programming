...
int bind_c_jacobi(int64_t n0_a, int64_t n1_a, double *a, int64_t n0_b, int64_t n1_b, double *b, int64_t n0_x, int64_t n1_x, double *x, int64_t n, double eps, int64_t *stand, int64_t *iteration);
...
PyObject *jacobi_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    bind_c_jacobi(nd_ndim(&a, 0), nd_ndim(&a, 1), nd_data(&a), nd_ndim(&b, 0), nd_ndim(&b, 1), nd_data(&b), nd_ndim(&x, 0), nd_ndim(&x, 1), nd_data(&x), n, eps, &stand, &iteration);
    stand_tmp = Int64_to_PyLong(&stand);
...
static PyMethodDef mod_9rrbqdecmah4_9rrbqdecmah4_methods[] = {
    {
        "jacobi",
...
static PyModuleDef_Slot mod_9rrbqdecmah4_9rrbqdecmah4_slots[] = {
...
static struct PyModuleDef mod_9rrbqdecmah4_9rrbqdecmah4_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_9rrbqdecmah4_9rrbqdecmah4",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_9rrbqdecmah4_9rrbqdecmah4_methods,
    mod_9rrbqdecmah4_9rrbqdecmah4_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_9rrbqdecmah4_9rrbqdecmah4(void)
{
    import_array();
    return PyModuleDef_Init(&mod_9rrbqdecmah4_9rrbqdecmah4_module);
}
