...
int64_t bind_c_strassen_multiply(int64_t n0_A, int64_t n1_A, double *A, int64_t n0_B, int64_t n1_B, double *B, int64_t n0_C, int64_t n1_C, double *C, int64_t n);
...
PyObject *strassen_multiply_wrapper(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    Out_0001 = bind_c_strassen_multiply(nd_ndim(&A, 0), nd_ndim(&A, 1), nd_data(&A), nd_ndim(&B, 0), nd_ndim(&B, 1), nd_data(&B), nd_ndim(&C, 0), nd_ndim(&C, 1), nd_data(&C), n);
...
static PyMethodDef mod_f7whybho61ze_f7whybho61ze_methods[] = {
    {
        "strassen_multiply",
...
static PyModuleDef_Slot mod_f7whybho61ze_f7whybho61ze_slots[] = {
...
static struct PyModuleDef mod_f7whybho61ze_f7whybho61ze_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_f7whybho61ze_f7whybho61ze",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_f7whybho61ze_f7whybho61ze_methods,
    mod_f7whybho61ze_f7whybho61ze_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_f7whybho61ze_f7whybho61ze(void)
{
    import_array();
    return PyModuleDef_Init(&mod_f7whybho61ze_f7whybho61ze_module);
}
