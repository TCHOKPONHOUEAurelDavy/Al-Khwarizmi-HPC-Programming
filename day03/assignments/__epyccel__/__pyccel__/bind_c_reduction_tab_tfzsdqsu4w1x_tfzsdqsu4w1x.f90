module bind_c_reduction_tab_tfzsdqsu4w1x_tfzsdqsu4w1x

  use reduction_tab_tfzsdqsu4w1x_tfzsdqsu4w1x, only: reduction
  use reduction_tab_tfzsdqsu4w1x_tfzsdqsu4w1x, only: initialize_table
...
end module bind_c_reduction_tab_tfzsdqsu4w1x_tfzsdqsu4w1x
