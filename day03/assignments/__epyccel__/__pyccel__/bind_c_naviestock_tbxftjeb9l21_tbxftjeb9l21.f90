module bind_c_naviestock_tbxftjeb9l21_tbxftjeb9l21

  use naviestock_tbxftjeb9l21_tbxftjeb9l21, only: cavity_flow_numba
  use naviestock_tbxftjeb9l21_tbxftjeb9l21, only: pressure_poisson_numba
  use naviestock_tbxftjeb9l21_tbxftjeb9l21, only: build_up_b_numba
  ...
  function bind_c_pressure_poisson_numba(n0_p, n1_p, p, dx, dy, n0_b, &
        n1_b, b, nit) bind(c) result(Out_0002)
  ...
  function bind_c_cavity_flow_numba(nt, n0_u, n1_u, u, n0_v, n1_v, v, dt &
        , nx, ny, dx, dy, n0_p, n1_p, p, rho, nu, nit) bind(c) result( &
        Out_0003)
...
end module bind_c_naviestock_tbxftjeb9l21_tbxftjeb9l21
