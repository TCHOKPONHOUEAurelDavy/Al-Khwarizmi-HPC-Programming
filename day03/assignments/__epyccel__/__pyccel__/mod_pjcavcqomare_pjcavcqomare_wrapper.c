...
static PyMethodDef mod_pjcavcqomare_pjcavcqomare_methods[] = {
    {
        "matrix_prod",
...
static PyModuleDef_Slot mod_pjcavcqomare_pjcavcqomare_slots[] = {
...
static struct PyModuleDef mod_pjcavcqomare_pjcavcqomare_module = {
    PyModuleDef_HEAD_INIT,
    /* name of module */
    "mod_pjcavcqomare_pjcavcqomare",
    /* module documentation, may be NULL */
    NULL,
    /* size of per-interpreter state of the module, or -1 if the module keeps state in global variables. */
    0,
    mod_pjcavcqomare_pjcavcqomare_methods,
    mod_pjcavcqomare_pjcavcqomare_slots
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_pjcavcqomare_pjcavcqomare(void)
{
    import_array();
    return PyModuleDef_Init(&mod_pjcavcqomare_pjcavcqomare_module);
}
