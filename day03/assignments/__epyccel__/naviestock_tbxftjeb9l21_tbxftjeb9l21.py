...
def pressure_poisson_numba(p, dx, dy, b, nit):
    import numpy as np
...
@types('int','float[:,:]', 'float[:,:]','float','int','int','float','float','float[:,:]','float','float','int')
def cavity_flow_numba(nt, u, v, dt, nx, ny, dx, dy, p, rho, nu,nit):
    import numpy as np
    ...
    for n in range(nt):
        ...
        pressure_poisson_numba(p, dx, dy, b, nit)
